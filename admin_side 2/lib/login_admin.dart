...
import 'dart:convert';
import 'package:admin_side/admin_dashboard.dart'; // Adjust this import according to your project structure
        ...
        if (accessToken != null) {
          ...
          if (role == 'Admin') {
            Navigator.pushReplacement(
              context,
              MaterialPageRoute(
                builder: (context) => AdminDashboard(accessToken: accessToken),
              ),
            );
          } else {
            setState(() {
